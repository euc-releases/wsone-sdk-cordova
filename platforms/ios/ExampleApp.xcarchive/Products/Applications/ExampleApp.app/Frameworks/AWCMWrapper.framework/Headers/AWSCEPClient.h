...
@interface AWSCEPEnrollment : AWCMWrapperModuleAPIObject
...
@interface AWSCEPIdentity : AWCMWrapperModuleAPIObject
...
@interface AWSCEPClient : AWCMWrapperModuleAPIObject
