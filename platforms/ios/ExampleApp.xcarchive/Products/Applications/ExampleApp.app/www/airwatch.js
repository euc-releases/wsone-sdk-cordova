module.exports = {
    ...
    isCompromised: function (successCallback, errorCallback) {
        cordova.exec(successCallback, errorCallback, "AirwatchSDK", "isCompromised", []);
    },

    registerPushNotificationToken:function (token, successCallback, errorCallback) {
        cordova.exec(successCallback, errorCallback, "AirwatchSDK", "registerPushNotificationToken", [token]);
    },
    // Internal
