...
import com.airwatch.cordova.sdkplugin.commands.PushNotificationTokenRegistrationCommand;
...
public class AirwatchSDKPlugin extends CordovaPlugin {
    ...
    private void initializeCommandMap(){
        ...
        commandsMap.put(Command.REGISTER_TOKEN,new PushNotificationTokenRegistrationCommand());
